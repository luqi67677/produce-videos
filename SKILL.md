...
- 一段口播只绑定一个镜头；每个镜头写明叙事职责、连续性锚点、主素材、A/B-roll 职责、人物 ID、布局编号、构图预算、开始/变化/结束状态、可见证据、录屏入出点、运动语法、平台遮挡和隐私复核。
...
项目至少保留：brief、主张账本、叙事契约、完整口播、真实素材清单、原始素材审片计划、视觉候选、唯一主题、需要时的创作记忆和人物档案、声音需求与选择、旁白契约、镜头就绪表、EDL（需要剪辑时）、运动覆盖、V2 审批账本、平台遮挡审查图、分镜、代表性微样片、完整低清预览、正式视频、质检报告和联系表。
